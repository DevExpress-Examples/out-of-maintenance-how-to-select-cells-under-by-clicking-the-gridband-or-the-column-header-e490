...
Namespace Q130069
	...
	Partial Public Class CarsDBDataSet
		...
		Partial Public Class CarsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCarsRow(ByVal Trademark As String, ByVal Model As String, ByVal Liter As Double, ByVal Cyl As Byte, ByVal TransmissSpeedCount As Byte, ByVal TransmissAutomatic As String, ByVal Category As String, ByVal Price As Decimal) As CarsRow
				Dim rowCarsRow As CarsRow = (CType(Me.NewRow(), CarsRow))
				Dim columnValuesArray() As Object = { Nothing, Trademark, Model, Liter, Cyl, TransmissSpeedCount, TransmissAutomatic, Category, Price}
	...
	End Class
End Namespace
Namespace Q130069.CarsDBDataSetTableAdapters
	...
	Partial Public Class CarsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `Liter`, `Cyl`, `TransmissSpeedCount`, " & "`TransmissAutomatic`, `Category`, `Price`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Trademark` = ?, `Model` = ?, `Liter` = ?, `Cyl` = ?, `TransmissSpeedCount` = ?, `TransmissAutomatic` = ?, `Category` = ?, `Price` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `Liter` IS NULL) OR (`Liter` = ?)) AND ((? = 1 AND `Cyl` IS NULL) OR (`Cyl` = ?)) AND ((? = 1 AND `TransmissSpeedCount` IS NULL) OR (`TransmissSpeedCount` = ?)) AND ((? = 1 AND `TransmissAutomatic` IS NULL) OR (`TransmissAutomatic` = ?)) AND ((? = 1 AND `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ID, Trademark, Model, Liter, Cyl, TransmissSpeedCount, TransmissAutomatic," & " Category, Price FROM Cars"
		...
		Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_Liter As Global.System.Nullable(Of Double), ByVal Original_Cyl As Global.System.Nullable(Of Byte), ByVal Original_TransmissSpeedCount As Global.System.Nullable(Of Byte), ByVal Original_TransmissAutomatic As String, ByVal Original_Category As String, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
			...
			If (Original_Liter.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(6).Value = (CDbl(Original_Liter.Value))
			Else
			...
			If (Original_Cyl.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CByte(Original_Cyl.Value))
			Else
			...
			If (Original_TransmissSpeedCount.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(10).Value = (CByte(Original_TransmissSpeedCount.Value))
			Else
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(12).Value = (CStr(Original_TransmissAutomatic))
			End If
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(14).Value = (CStr(Original_Category))
			End If
		...
		Public Overridable Function Insert(ByVal Trademark As String, ByVal Model As String, ByVal Liter As Global.System.Nullable(Of Double), ByVal Cyl As Global.System.Nullable(Of Byte), ByVal TransmissSpeedCount As Global.System.Nullable(Of Byte), ByVal TransmissAutomatic As String, ByVal Category As String, ByVal Price As Global.System.Nullable(Of Decimal)) As Integer
			...
			If (Liter.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(2).Value = (CDbl(Liter.Value))
			Else
				Me.Adapter.InsertCommand.Parameters(2).Value = Global.System.DBNull.Value
			End If
			If (Cyl.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(3).Value = (CByte(Cyl.Value))
			Else
				Me.Adapter.InsertCommand.Parameters(3).Value = Global.System.DBNull.Value
			End If
			If (TransmissSpeedCount.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(4).Value = (CByte(TransmissSpeedCount.Value))
			Else
			...
			Else
				Me.Adapter.InsertCommand.Parameters(5).Value = (CStr(TransmissAutomatic))
			End If
			If (Category Is Nothing) Then
				Me.Adapter.InsertCommand.Parameters(6).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.InsertCommand.Parameters(6).Value = (CStr(Category))
			End If
		...
		Public Overridable Function Update(ByVal Trademark As String, ByVal Model As String, ByVal Liter As Global.System.Nullable(Of Double), ByVal Cyl As Global.System.Nullable(Of Byte), ByVal TransmissSpeedCount As Global.System.Nullable(Of Byte), ByVal TransmissAutomatic As String, ByVal Category As String, ByVal Price As Global.System.Nullable(Of Decimal), ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_Liter As Global.System.Nullable(Of Double), ByVal Original_Cyl As Global.System.Nullable(Of Byte), ByVal Original_TransmissSpeedCount As Global.System.Nullable(Of Byte), ByVal Original_TransmissAutomatic As String, ByVal Original_Category As String, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
			If (Trademark Is Nothing) Then
			...
			End If
			If (Liter.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(2).Value = (CDbl(Liter.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(2).Value = Global.System.DBNull.Value
			End If
			If (Cyl.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CByte(Cyl.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(3).Value = Global.System.DBNull.Value
			End If
			If (TransmissSpeedCount.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CByte(TransmissSpeedCount.Value))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(5).Value = (CStr(TransmissAutomatic))
			End If
			If (Category Is Nothing) Then
				Me.Adapter.UpdateCommand.Parameters(6).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CStr(Category))
			End If
			If (Price.HasValue = True) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CStr(Original_Model))
			End If
			If (Original_Liter.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(13).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(14).Value = (CDbl(Original_Liter.Value))
			Else
			...
			If (Original_Cyl.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(16).Value = (CByte(Original_Cyl.Value))
			Else
			...
			If (Original_TransmissSpeedCount.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(18).Value = (CByte(Original_TransmissSpeedCount.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(20).Value = (CStr(Original_TransmissAutomatic))
			End If
			If (Original_Category Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(22).Value = (CStr(Original_Category))
			End If
			If (Original_Price.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(23).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(24).Value = (CDec(Original_Price.Value))
			Else
